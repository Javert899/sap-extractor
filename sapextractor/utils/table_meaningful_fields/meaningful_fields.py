...
def apply(con, tab_name):
    ...
    fname_rollname = {x["FIELDNAME"]: x["ROLLNAME"] for x in table_dict}
    ...
    return primary_keys, foreign_keys, timestamp_resource, fields_with_type, fname_checktable, fname_rollname
